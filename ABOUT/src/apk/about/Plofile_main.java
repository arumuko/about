...
public class Plofile_main extends Activity{
    ...
    public void onCreate(Bundle savedInstanceState) {
    	...
    	ABOUT_DBHelper.update_Profile(db, user_id, user_name, user_height, user_weight,  user_rent,
				user_bloodtype, user_revenue, user_birthplace, user_job, user_birthday);
    	ABOUT_DBHelper.update_Other(db, user_id, user_name);
    	db.close();

    	//遷移先にデータの送信？
    	intent.putExtra("sendText1",user_name);
