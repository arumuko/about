...
public class Collection_6 extends ListActivity {
	
	public static final String TAG = null;
	ListView listView;
	String[] result = null;
	String[] res = null;
	String url = "http://birdboy.sakura.ne.jp/about/collection/selectCollectionInstrument.php";
	...
	public boolean onOptionsItemSelected(MenuItem item) {     
	   ...
	   private class getItem extends AsyncTask<Void, Void, Void> {
			...
			protected void onPreExecute() {
				super.onPreExecute();
				mProgressDialog = new ProgressDialog(Collection_6.this);
			...
			protected void onPostExecute(Void result) {
		        ...
		        adapter = new ArrayAdapter<String>(Collection_6.this, android.R.layout.simple_list_item_1,0,item);
